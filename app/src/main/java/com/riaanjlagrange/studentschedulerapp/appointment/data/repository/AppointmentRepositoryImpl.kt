...
import com.riaanjlagrange.studentschedulerapp.appointment.data.mapper.toFireBaseError
...
class AppointmentRepositoryImpl(
    ...
    override suspend fun bookAppointment(appt: Appointment): Either<FirebaseError, String> {
        return try {
            ...
            Either.Left(e.toFireBaseError(e))
        }
    }

    // fetch appointment for user
    override suspend fun getAppointments(userId: String): Either<FirebaseError, List<Appointment>> {
        return try {

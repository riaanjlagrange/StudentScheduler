...
interface UsersRepository {
    ...
    suspend fun getStudentById(studentId: String): Either<FirestoreError, List<AuthUser>>
    suspend fun getAllLecturers(): Either<FirestoreError, List<AuthUser>>
    suspend fun getLecturerById(lecturerId: String): Either<FirestoreError, List<AuthUser>>
}
